;MULTIBALL
    ...
    !TimeBetweenSpawns  = $3F   ; needs to be one less than a power of 2
...
.next
	DEX
	BPL -
	LDA $1DFC|!addr	;Overwrite all attempts at playing the Bullet Bill sound effect with a custom one
	CMP.b #$09	;(Many things use this same exact sound effect, except for castle entrance doors)
	BNE +
	LDA.b #$30
	STA $1DF9|!addr
+
