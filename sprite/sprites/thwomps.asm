...
; Sets whether or not the facial expression changes when you approach
!WaitLookEye = 1

; Align the eyes with the direction of movement
!AngryEyesDirectionFix = 0
...
;If these two are the same, This tile is flip vertical when moving up.
!AngryThwompTileU = $E0	;
!AngryThwompTileD = $CA	;

;If these two are the same, This tile is flip horizontal when moving right.
!AngryThwompTileR = $C8
!AngryThwompTileL = $C8

if !AngryEyesDirectionFix
AngryThwompTile:
db !AngryThwompTileU
db !AngryThwompTileD
db !AngryThwompTileR
...
if !AngryEyesDirectionFix
	LDA #$00
	LDY !160E,x
	if !AngryThwompTileU = !AngryThwompTileD
		BNE $02 : ORA #$80
		endif
		if !AngryThwompTileR = !AngryThwompTileL
		CPY #$02 : BNE $02 : ORA #$40
		endif
	STA $05
	+
	LDA AngryThwompTile,y
	STA $04
	endif
    %GetDrawInfo()
...
if !AngryEyesDirectionFix
	...
	ORA $0303|!Base2,y
	STA $0303|!Base2,y
	LDA $04 : BRA PrepareNextGFXLoop-1
	else
	LDA.b #!AngryThwompTileD
	endif
DefaultExpression:
if !ThwompFacePatch
	XBA
